...
<!--
    <div class="row">
        ...
        <?php
            ...
            {
                if($i == $page)
                    echo "<a href='main.php?cmd=$cmd&page=$i&keyword=$keyword'><span class='badge bg-danger'>$i</span></a> ";
                else
                    echo "<a href='main.php?cmd=$cmd&page=$i&keyword=$keyword'><span class='badge bg-secondary'>$i</span></a> ";
            }
        ?>
        </div>
    </div>
